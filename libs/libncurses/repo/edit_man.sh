...
TERMINFO="/home/hty/rootfs/libs/libncurses/build/share/terminfo"
...
(*.[0-9]*)
	...
	if test ! -f /home/hty/rootfs/libs/libncurses/repo/man_alias.sed ; then
cat >>/home/hty/rootfs/libs/libncurses/repo/man_alias.sed <<-CF_EOF2
		s,@DATADIR@,$datadir,g
...
s,@TSET@,tset,g
CF_EOF2
		echo "...made /home/hty/rootfs/libs/libncurses/repo/man_alias.sed"
	fi
	...
	aliases=`sed -f $top_srcdir/man/manlinks.sed $inalias |sed -f /home/hty/rootfs/libs/libncurses/repo/man_alias.sed | sort -u; test $inalias = $nCurses && echo curses`
	cf_target=`grep "^$cf_source" /home/hty/rootfs/libs/libncurses/repo/man/man_db.renames | mawk '{print $2}'`
	...
	sed	-f /home/hty/rootfs/libs/libncurses/repo/man_alias.sed \
		< $i | sed -f /home/hty/rootfs/libs/libncurses/repo/edit_man.sed >$TMP

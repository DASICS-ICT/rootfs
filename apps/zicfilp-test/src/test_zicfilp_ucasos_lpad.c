/*
 * UCAS-OS Zicfilp LPAD Validation Test
 *
...
/*
 * Inline syscall macros - safe to use with Zicfilp enabled
 */
 ...
 * Must use inline syscalls to avoid function calls */
int jump_with_elp(void *func, long x7_val) {
    int result;

    /* Enable Zicfilp */
    syscall_inline1(SYSCALL_ZICFILP_SET, 1);
...
int main(void) {
    ...
    printf("\n============================================\n");
    printf("UCAS-OS Zicfilp LPAD Validation Test\n");
    printf("============================================\n\n");

...
free() exported functions will be declared __declspec(dllimport), with
...
int idx0 = (int)LIBCFG_ALLOC(DASICS_LIBCFG_R | DASICS_LIBCFG_V, pattern, pattern_len + 1);
int idx1 = (int)LIBCFG_ALLOC(DASICS_LIBCFG_R | DASICS_LIBCFG_V | DASICS_LIBCFG_W, &error, sizeof(error));
int idx2 = (int)LIBCFG_ALLOC(DASICS_LIBCFG_R | DASICS_LIBCFG_V | DASICS_LIBCFG_W, &erroffset, sizeof(erroffset));
